        ...
        <div>
            <div className='property-card'>
                ...
                <div className='property-info'>
                    ...
                    {isUpdate ? (
                        <FormUpdateProperty proper={proper} setProperty={setProperty} setIsUpdate={setIsUpdate} />
                    ) : (
                        <>
                            ...
                            {user && user?.isAdmin && (
                                <>
                                    <button className='favorite-button' onClick={() => setIsUpdate(true)}>
                                        Изменить
                                    </button>
                                    <button className='favorite-button' onClick={() => console.log('Удалить')}>
                                        Удалить
                                    </button>
                                </>
                            )}
